    ...
    inner class CategoriesViewHolder(private val binding: ItemGenreBinding) :
        ...
        private fun getDrawableByGenre(genreId: Int): Drawable? {
            ...
            return when (getGenreByKey(genreId)) {
                ...
                genres[1] -> AppCompatResources.getDrawable(context, R.drawable.ic_adventure)
                genres[2] -> AppCompatResources.getDrawable(context, R.drawable.ic_comedy)
                genres[3] -> AppCompatResources.getDrawable(context, R.drawable.ic_crime)
                genres[4] -> AppCompatResources.getDrawable(context, R.drawable.ic_drama)
                genres[5] -> AppCompatResources.getDrawable(context, R.drawable.ic_family)
                genres[6] -> AppCompatResources.getDrawable(context, R.drawable.ic_horror)
                genres[7] -> AppCompatResources.getDrawable(context, R.drawable.ic_romance)
                genres[8] -> AppCompatResources.getDrawable(context, R.drawable.ic_scifi)
                genres[9] -> AppCompatResources.getDrawable(context, R.drawable.ic_thriller)
